      ...
      while (requesting) {
        ...
        switch(choice) {
          ...
          case 3:
            ...
            break;
          case 4:
            System.out.println("Choose charCount. Enter the string to analyze:");
            String text = scanner.nextLine();
            json.put("type", "charcount");
            json.put("count", text);
            System.out.println("Would you like to search for a specific character? (yes/no)");
            ...
            break;
          case 5:
            System.out.println("Choose inventory. Options: 'add', 'view', 'buy'.");
            ...
            if (task.equals("add") || task.equals("buy")) {
              ...
              json.put("quantity", Integer.parseInt(scanner.nextLine()));
            }
            break;
          default:
